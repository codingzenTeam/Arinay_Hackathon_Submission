...
icon = PhotoImage(file = "C:\Users\My PC\Downloads\Hackathon\Hackathon\icon.png")
# icon = PhotoImage(file = "icon.png")
win.iconphoto(False,icon)
win.resizable(0,0)
win.configure(bg="#393940")
...
input_frame = Frame(win, width=312, height=100, bd=-20, highlightbackground="black",highlightcolor="black", highlightthickness=2, padx=0, pady=0,background="#393940",bg = "#393940")
inpu = input_frame
...
buttons_frame = tk.Frame(win, width=236, height=272, padx=0, pady=0, bd=-20)
buttons_frame.pack()
...
negative_positive = Button(buttons_frame, text="-/+", fg="#eee", width=6, height=3, bd=0, bg="#393940", activebackground="#bbbabf", takefocus=0, command=lambda: sign()).grid(row=0, column=1, padx=0, pady=0, columnspan=1)
...
# Fifth row
zero = Button(buttons_frame, text="0", fg="#eee", width=6, height=3, bd=0, bg="#595960", takefocus=0, activebackground="#bbbabf", command=lambda: click(0)).grid(row=4, column=0, columnspan=1, padx=0, pady=0)
...
backspace = Button(buttons_frame, text="⌫", fg="#eee", width=6, height=3, bd=0, bg="#595960", takefocus=0, activebackground="#bbbabf", command=lambda: delete()).grid(row=4, column=2, columnspan=1, padx=0, pady=0)
equals = Button(buttons_frame, text="=", fg="#eee", width=13, height=3, bd=0, bg="#ff9f0b", takefocus=0, activebackground="#bbbabf", command=lambda: calc()).grid(row=4, column=3, padx=0, pady=0, columnspan=2)
